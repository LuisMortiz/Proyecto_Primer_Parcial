                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="date" name="fechanacimiento" id="fechanacimiento" class="form-control" placeholder="Edad">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
...
if(edad < 18){
  ...
  position: "top-end",
  icon: "warning",
  title: "¡Alerta! El Cliente es menor de edad",
  showConfirmButton: false,
  timer: 2000
});


} else if(nombre == ""||ap_paterno== ""||ap_materno ==""||sexo == ""||Edades== ""||fechanacimiento==""||curp ==""||
